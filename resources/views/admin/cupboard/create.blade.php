...
{!! Form::open(array('route' => 'admin.cupboard.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('material_fasade', old('material_fasade'), array('class'=>'form-control')) !!}
